...
export default function Config() {
  ...
  return (
    <AppShell
      ...
      description="Gestiona los trabajadores con acceso al sistema."
      actions={
        ...
        {isLoading ? (
          ...
          <Card className="p-8 text-center">
            <p className="text-sm text-muted-foreground">
              Aún no hay trabajadores. Crea el primero para comenzar.
            </p>
    ...
    >
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Se enviará un correo de verificación al email indicado.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="juan@beastclub.com"
              autoComplete="off"
              maxLength={255}
            />
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-md border p-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Marca como inactivo para deshabilitar al trabajador.
              </p>
            </div>
